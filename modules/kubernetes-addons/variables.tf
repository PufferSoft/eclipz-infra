...
variable "enable_promtail" {
  description = "Enable Community promtail add-on"
  type        = bool
  default     = false
}

variable "enable_loki" {
  description = "Enable Community loki add-on"
  type        = bool
  default     = false
}
...
variable "promtail_helm_config" {
  description = "Community promtail Helm Chart config"
  type        = any
  default     = {}
}

variable "loki_helm_config" {
  description = "Community loki Helm Chart config"
  type        = any
  default     = {}
}
...
variable "enable_jenkins" {
  type        = bool
  default     = false
  description = "Enable Jenkins CI Kubernetes add-on"
}

variable "jenkins_helm_config" {
  type        = any
  default     = {}
  description = "Jenkins CI Kubernetes add-on config"
}
